<template>
	<view class="page_wrap">
		<view class="top">
			<search-comprehensive placeholder='搜索商品' :showScreen='true' @searchInput="searchInput"
				@selectFilter="selectFilter" :showClassify="true">
				...
				<template>
					<view class="foot_con row">
						<view class="check_wrap">
							<view @click="selectAll(2)" v-if="total<pageList.length" class="iconfont icon-weixuanze">
							</view>
