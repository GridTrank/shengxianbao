<template>
	<view class="page_wrap">
		<view class="page_type mt40">
			...
			<view class="sub_txt mt20">密码为8-16位，须包含数字、字母、符号</view>
		</view>
		<view class="input_wrap">
			<u--form ref='form' :model="model" :rules="rules" >
				<u-form-item prop="account">
					<view class="input_item ">
						<view class="label">当前账号</view>
						<u-input class="mt10" placeholder='请输入当前账号' border='bottom' v-model="model.account"></u-input>
					</view>
				</u-form-item>
				...
				<u-form-item prop="password">
					<view class="input_item ">
						...
						<u-input class="mt10" placeholder='请输入密码' border='bottom' v-model="model.password"></u-input>
					</view>
				</u-form-item>
				...
				<u-form-item prop="newPassword">
					<view class="input_item ">
						...
						<u-input class="mt10" placeholder='请输入新密码' border='bottom' v-model="model.newPassword"></u-input>
					</view>
				</u-form-item>
			</u--form>
		</view>
